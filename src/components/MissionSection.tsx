...
const MissionSection = () => {
  return (
    <section id="mission" className="py-24 relative">
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-akin-blue/5 rounded-full blur-3xl -z-10"></div>
      <div className="container">
        <div className="flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-2/5">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-akin-purple/20 to-akin-blue/20 rounded-full transform rotate-45 scale-90"></div>
              <div className="relative bg-black/20 backdrop-blur-sm p-8 rounded-xl border border-white/10">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-akin-purple to-akin-blue mb-6">
          ...
          <div className="md:w-3/5">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-1 md:col-span-3">
                <div className="bg-akin-purple/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 text-center">
              ...
              <div className="col-span-1">
                <div className="h-full bg-black/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center hover:bg-black/20 transition-all duration-300">
                  <div className="w-12 h-12 rounded-full bg-akin-purple/20 flex items-center justify-center mb-4">
              ...
              <div className="col-span-1">
                <div className="h-full bg-black/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center hover:bg-black/20 transition-all duration-300">
                  <div className="w-12 h-12 rounded-full bg-akin-blue/20 flex items-center justify-center mb-4">
              ...
              <div className="col-span-1">
                <div className="h-full bg-black/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center hover:bg-black/20 transition-all duration-300">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-akin-purple/20 to-akin-blue/20 flex items-center justify-center mb-4">
