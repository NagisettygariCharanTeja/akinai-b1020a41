        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex space-x-2">
              <Input type="password" placeholder="Enter your Together.ai API key" value={config.apiKey} onChange={e => setConfig({
              ...config,
          ...
          <div>
            ...
            model: value
              ...
              <SelectContent className={isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}>
                {models.map(model => <SelectItem key={model.value} value={model.value} className={isDarkMode ? 'text-white hover:bg-slate-700' : 'text-gray-900 hover:bg-gray-100'}>
                    {model.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
          ...
          <div className="flex space-x-2 pt-4">
            ...
            <Button variant="outline" onClick={() => onOpenChange(false)} className="bg-gray-700 hover:bg-gray-600">
              Cancel
            </Button>
          </div>
        </div>
