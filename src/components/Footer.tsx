          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div className="mr-3">
                  <div className="w-10 h-10">
                    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20 0L40 20H30L20 10L10 20H0L20 0Z" fill="white"/>
                    </svg>
                  </div>
                </div>
                <div className="text-xl font-bold">akinAI</div>
              </div>
            ...
            <div>
              ...
              <p className="text-sm text-[#F5F5F5] mb-4">
                Join our newsletter for updates and early access.
              </p>
              <div className="flex">
                <input type="email" placeholder="Your email" className="px-4 py-2 bg-black/20 border border-white/10 rounded-l-md focus:outline-none focus:border-akin-purple" />
                <button className="px-4 py-2 bg-gradient-to-r from-akin-purple to-akin-blue text-white rounded-r-md hover:opacity-90 transition-opacity">
                  Subscribe
                </button>
              </div>
            </div>
